...
<?php $__env->startPush('css'); ?>
  <style type="text/css">
        .contactus_page{
background-image: linear-gradient(rgba(54,92,169,0.7),rgba(54,92,169,0.7)),url(<?php echo e(asset('website/img/Mask_Group_12.png')); ?>);
min-height: 100vh;
}
.inner_col {
    padding: 40px;
...
<?php $__env->startSection('content'); ?>
    <section class="contactus_page">
        ...
        <div class="container">
            <div class="inner_col">
                <form class="row" action="<?php echo e(route('contact_request')); ?>" method="post">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('website.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/democustompro/public_html/laravel/alzuwar/alziyara_main_files/resources/views/website/contact_us.blade.php ENDPATH**/ ?>