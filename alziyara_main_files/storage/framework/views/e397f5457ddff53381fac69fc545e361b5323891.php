...
<script src="<?php echo e(asset('plugins/components/raphael/raphael-min.js')); ?>"></script>
<script src="<?php echo e(asset('plugins/components/morrisjs/morris.js')); ?>"></script>

<script type="text/javascript">
    Morris.Donut({
        element: 'morris-donut-chart',
        data: [
                <?php $__currentLoopData = $country_users_count; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            {
                label: "<?php echo e($item->country??''); ?>",
...
//                        ['', ''],
            <?php if(Auth::user()->hasRole('SuperAdmin')): ?>
            ['Hotels/Properties', <?php echo e($hotelsSales??''); ?> ],
            ['PackegesDeals', <?php echo e($packagesSales??''); ?>],
            ['ShrinePrograms', <?php echo e($guestpassSales??''); ?>],
            ['Guides', <?php echo e($guideSales??''); ?>],
            ['Transportations', <?php echo e($transportSales??''); ?>]
            <?php else: ?>
                ...
                <?php if(Auth::user()->hasRole('GuestsPassAdmin')): ?>
                    ['ShrinePrograms', <?php echo e($guestpassSales??''); ?>],
                <?php endif; ?>
                <?php if(Auth::user()->hasRole('GuideAdmin')): ?>
                    ['Guides', <?php echo e($guideSales??''); ?>],
                <?php endif; ?>
                <?php if(Auth::user()->hasRole('TransportAdmin')): ?>
                    ['Transportations', <?php echo e($transportSales??''); ?>]
                <?php endif; ?>
            <?php endif; ?>
        ]);
...
//                        ['', ''],
            <?php if(Auth::user()->hasRole('SuperAdmin')): ?>
            ['Hotels/Properties', <?php echo e($hotelsCounts??''); ?>],
            ['PackegesDeals', <?php echo e($packagesCounts??''); ?>],
            ['ShrinePrograms', <?php echo e($guestpassCounts??""); ?>],
            ['Guides', <?php echo e($guideCounts??''); ?>],
            ['Transportations', <?php echo e($transportCounts??''); ?>]
            <?php else: ?>
                <?php if(Auth::user()->hasRole('HotelsAdmin')): ?>
                    ['Hotels/Properties', <?php echo e($hotelsCounts??''); ?>],
                <?php endif; ?>
...
Morris.Donut({
        ...
        data: [{
            label: "Packages",
            value: <?php echo e($packages??''); ?>

        }, {
            label: "Hotel/Property",
            value: <?php echo e($hotels??''); ?>

        }, {
            label: "Guestpass",
            value: <?php echo e($guestpass??''); ?>

        },{
            label: "Guide",
            value: <?php echo e($guides??''); ?>


        }, {
            label: "Customer",
            value: <?php echo e($customers??''); ?>

        }, {
            label: "Transport",
            value: <?php echo e($transports??''); ?>
            ...
            data: [{
                ...
                dataPoints: [
                    { x: new Date(2021, 01, 01), y: 0 },
                        <?php $__currentLoopData = $mothly_sales_data['packages_monthly_sales']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    { x: new Date(<?php echo e($data->new_date); ?>), y: <?php echo e($data->total); ?> },
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ]
            },
                {
                    ...
                    dataPoints: [
                        {
                            x: new Date(2021, 01, 01), y: 0 },
                            <?php $__currentLoopData = $mothly_sales_data['hotel_monthly_sales']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                { x: new Date(<?php echo e($data->new_date); ?>), y: <?php echo e($data->total); ?> },
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ]
                },
                {
                    ...
                    dataPoints: [
                        { x: new Date(2021, 01, 01), y: 0 },
                            <?php $__currentLoopData = $mothly_sales_data['transport_monthly_sales']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        { x: new Date(<?php echo e($data->new_date); ?>), y: <?php echo e($data->total); ?> },
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ]
                },
                {
                    ...
                    dataPoints: [
                        { x: new Date(2021, 01, 01), y: 0 },
                            <?php $__currentLoopData = $mothly_sales_data['shrines_monthly_sales']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        { x: new Date(<?php echo e($data->new_date); ?>), y: <?php echo e($data->total); ?> },
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ]
                },
                {
                    ...
                    dataPoints: [
                        { x: new Date(2021, 01, 01), y: 0 },
                            <?php $__currentLoopData = $mothly_sales_data['guide_monthly_sales']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        { x: new Date(<?php echo e($data->new_date); ?>), y: <?php echo e($data->total); ?> },
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ]
                }]
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/democustompro/public_html/laravel/alzuwar/alziyara_main_files/resources/views/dashboard/index.blade.php ENDPATH**/ ?>