...
<div role="article" aria-label="An email from AlZuwar" lang="en" style="background-color: white; color: #2b2b2b; font-family: 'Avenir Next', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px; font-weight: 400; line-height: 28px; margin: 0 auto; max-width: 600px; padding: 40px 20px 40px 20px;">
    ...
    <main>
        <div style="background-color: ghostwhite; border-radius: 4px; padding: 24px 48px;">
            ...
            <a href="<?php echo e(url('emailverify')); ?>/<?php echo e($datas['VerifyToken']); ?>" style="color: #B200FD; text-decoration: underline;">Click here to confirm your email</a>
            <p>
                If that doesn't work, copy and paste the following link in your browser:
                <br />
                <br />
                <a href="<?php echo e(url('emailverify')); ?>/<?php echo e($datas['VerifyToken']); ?>" style="color: #B200FD; text-decoration: underline;"><?php echo e(url('emailverify')); ?>/<?php echo e($datas['VerifyToken']); ?></a>
            </p>
            <p>
    ...
    <footer>
        <p style="font-size: 16px; font-weight: 400; line-height: 24px; margin-top: 48px;">
            You received this email because your email was used in creating a profile at <strong><a href="<?php echo e(route('index')); ?>">Alzuwar</a></strong>
        </p>
    </footer>
</div>
</td></tr></table>
</body>
</html><?php /**PATH /home2/democustompro/public_html/laravel/alzuwar/alziyara_main_files/resources/views/mail/testmail.blade.php ENDPATH**/ ?>