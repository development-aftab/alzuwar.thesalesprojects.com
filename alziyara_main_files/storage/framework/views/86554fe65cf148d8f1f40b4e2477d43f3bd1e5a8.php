...
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script type="text/javascript">
        ...
        $('#calendar').fullCalendar({
            ...
            events: [
                ...
                <?php $__currentLoopData = $transportbooking; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ourtransportbooking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   {	
				   
				   
						<?php if(( $ourtransportbooking->BookingStatus == 'CONFIRMED' ) && ($ourtransportbooking->PaymentStatus == 'PAID' ) && ($ourtransportbooking->request_refund_reply == '' ) ): ?>
							
						//PAID //CONFIRMED // request_refund == null Green color
						
						title:   '<?php echo e($ourtransportbooking->ReceiptNum??"Not Available"); ?>/<?php echo e($ourtransportbooking->getTransportUserDetail->name??''); ?>',
                        start:   '<?php echo e($ourtransportbooking->PickUpDateTime); ?>',
                        ...
                        id:      	'<?php echo e($ourtransportbooking->ReceiptNum??""); ?>',
                        comment: 	'<?php echo e($ourtransportbooking->SPComments); ?>',
                        color: 		'#2ecc71',
                        textColor: 	'white',
						<?php elseif(( $ourtransportbooking->BookingStatus == 'PENDING') && ($ourtransportbooking->request_refund_reply == '')): ?>
                        ...
                        color: 		'#ffa500',
                        textColor: 	'black',
						<?php elseif((($ourtransportbooking->BookingStatus == 'CANCELLED') || ($ourtransportbooking->PaymentStatus == 'UNPAID')) && ($ourtransportbooking->request_refund_reply == '') ): ?>
                        title:   '<?php echo e($ourtransportbooking->ReceiptNum??"Not Available"); ?>/<?php echo e($ourtransportbooking->getTransportUserDetail->name??''); ?>',
                        start:   '<?php echo e($ourtransportbooking->PickUpDateTime); ?>',
    ...
    <script>
        $(document).on('click','.fc-content',function(e){
            $.get('<?php echo e(URL::to("get-transport-invoice")); ?>/'+$(this).find('span.fc-title').text(),function(data){
                console.log(data);
                $('#insurance').hide();
                $('#donation').hide();
...
<script>
    $(document).on('click','#vehicle_name',function(e){
        ...
        location.href = "<?php echo e(url('transportdetails/')); ?>/"+id+'/'+name;
    });
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/democustompro/public_html/laravel/alzuwar/alziyara_main_files/resources/views/superadminviews/transportcalender.blade.php ENDPATH**/ ?>