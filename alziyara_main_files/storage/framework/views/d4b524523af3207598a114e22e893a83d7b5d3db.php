...
<head>
    ...
    <link href="<?php echo e(asset('website')); ?>/css/carousel.css" rel="stylesheet">
...
<?php echo $__env->make('website.google_multi_langual', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script type="text/javascript">
    <?php if(session()->has('msg')): ?>
            Swal.fire("<?php echo e(session()->get('title')??""); ?>","<?php echo e(session()->get('msg')??""); ?>","<?php echo e(session()->get('type')??""); ?>")
    <?php endif; ?>
</script>
<script>
...
<script type="text/javascript">
    <?php if(session('no_transportation_found')): ?>
        Swal.fire(
            'Sorry...',
            '<?php echo e(session('no_transportation_found')); ?>',
            'error'
        )
    <?php elseif(session('no_guide_found')): ?>
    Swal.fire(
        'Sorry...',
        '<?php echo e(session('no_guide_found')); ?>',
        'error'
    )
    <?php elseif(session('no_favourite_found')): ?>
    Swal.fire(
        'Sorry...',
        '<?php echo e(session('no_favourite_found')); ?>',
        'info'
    )
    <?php elseif(session('update_profile')): ?>
    Swal.fire(
        'Updated...',
        '<?php echo e(session('update_profile')); ?>',
        'success'
    )
    <?php elseif(session('vendors_not_allowed')): ?>
    Swal.fire(
        'Sorry...',
        '<?php echo e(session('vendors_not_allowed')); ?>',
        'error'
    )
    <?php endif; ?>
</script>
...
</html><?php /**PATH /home2/democustompro/public_html/laravel/alzuwar/alziyara_main_files/resources/views/website/layout/master.blade.php ENDPATH**/ ?>