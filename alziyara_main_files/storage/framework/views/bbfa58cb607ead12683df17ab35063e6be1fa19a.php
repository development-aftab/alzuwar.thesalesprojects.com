...
<body class="hotels transportation-details">
    ...
    <section class="sec-3">
        <div class="container">
            <div class="row">
                ...
                <?php else: ?>
                    <div class="col-lg-12 Alziyara text-center" data-aos="fade-right" data-aos-duration="3000">
                        <h3><?php echo ($pages->where('slug','reservation')->first()->title??'Not Available'); ?></h3>
                        <?php echo ($pages->where('slug','reservation')->first()->description??'Not Available'); ?>
                                ...
                                <div class="input-group" id="loc-from">
                                    ...
                                    <select class="form-control" name="destination" required>
                                        ...
                                        <?php $__currentLoopData = $cityNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cityName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($cityName->GuestPassLocation); ?>"
                                            <?php if($route_name == 'search-hotels'): ?>
                                                <?php if( $cityName->GuestPassLocation== $search_city): ?>
                                                    selected
                                                <?php endif; ?>
                                            <?php elseif( $cityName->GuestPassLocation=='Karbala'): ?>
                                                selected
                                            <?php endif; ?>
                                            ><?php echo e($cityName->GuestPassLocation); ?> </option>
                                 ...
                                 <div class="input-group" id="one-way">
                                    <div class="dropdown keep-open">
                                       ...
                                       <button id="dLabel" role="button" href="#" data-toggle="dropdown" data-target="#" class="btn btn-light">
                                          ...
                                          <span class="adults_span_hotels"><?php echo e($adults_hotels??0); ?></span> Adults,
                                          <span class="childs_span_hotels"><?php echo e($childs_hotels??0); ?></span> Children,
                                          <span class="infants_span_hotels"><?php echo e($infants_hotels??0); ?></span> Infants
                                       </button>
                                       <!-- Dropdown Menu -->
                                       <div class="dropdown-menu guests_dropdown" role="menu" aria-labelledby="dLabel">
                                          <div class="row">
                                             ...
                                             <div class="col-lg-3 col-md-4 col-sm-4 col-4"><span class="adults_input_field_hotels"><input type="number" class="form-control adults_hotels" name="adults_hotels" value="<?php echo e($adults_hotels??0); ?>" readonly min="0"></span></div>
                                          ...
                                          <div class="row">
                                             ...
                                             <div class="col-lg-3 col-md-4 col-sm-4 col-4"><span class="childs_input_field_hotels"><input type="number" class="form-control childs_hotels" name="childs_hotels" value="<?php echo e($childs_hotels??0); ?>" readonly min="0"></span></div>
                                          ...
                                          <div class="row">
                                             ...
                                             <div class="col-lg-3 col-md-4 col-sm-4 col-4"><span class="childs_input_field_hotels"><input type="number" class="form-control infants_hotels" name="infants_hotels" value="<?php echo e($infants_hotels??0); ?>" readonly min="0"></span></div>
    ...
    <section class="sec_hotel_detail" id="sec_hotel_detail">
        <?php echo $__env->make('website.hotel_card_section', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </section>
    ...
    <script>
        $(document).ready(function(){
            $("#sort_by").change(function(){
                <?php if($route_name == 'search-hotels'): ?>
                    $.get('<?php echo e(URL::to("hotels-sorting-with-city")); ?>/'+$("#sort_by").val()+'/<?php echo e($search_city); ?>',function(data){
                    // this.innerHTML('');
                ...
                <?php else: ?>
                    $.get('<?php echo e(URL::to("hotels-sorting")); ?>/'+$("#sort_by").val(),function(data){
                    // this.innerHTML('');
                    $('.sec_hotel_detail').empty();
                    // alert($("#sort_by").val());
                    $('.sec_hotel_detail').html(data);
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('website.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/democustompro/public_html/laravel/alzuwar/alziyara_main_files/resources/views/website/myhotels.blade.php ENDPATH**/ ?>