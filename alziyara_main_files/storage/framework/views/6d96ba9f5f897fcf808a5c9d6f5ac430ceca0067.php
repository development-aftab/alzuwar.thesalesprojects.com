   ...
   <section class="sec-1">
      <div class="vidbg-container">
         <video playsinline="" autoplay="" loop="" muted="">
            ...
            <source src="<?php echo e(asset('website')); ?>/videos/aerial-footage-hazrat-e-abbas.mp4" type="video/mp4">
         </video>
         ...
         <div class="row align-items-center ">
            <div class="col-md-12 col-lg-6 tabs_section" data-aos="fade-right" data-aos-duration="3000">
               ...
               <ul class="nav nav-tabs nav-pills" id="myTab" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                     <a class="nav-link" id="contact-tab" href="<?php echo e(route('flight')); ?>"
               ...
               <div class="tab-content" id="myTabContent">
                  ...
                  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                     <form role="form" id="form_Package_deals" class="margin-bottom-0" action="<?php echo e(route('search_package_deals')); ?>"  method="get">
                        <div class="form-row d-flex align-items-end">
                           <div class="form-group col-md-12">
                              <div class="input-group" id="loc-from">
                                 <label for=""><i class="fas fa-map-marker-alt"></i></label>
                                 <select class="form-control" name="owner_dm" value="<?php echo e($item->id??''); ?>" >
                                    ...
                                    <?php $__currentLoopData = $packageType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <option value="<?php echo e($item->id??''); ?>" ><?php echo e($item->package_deals_type_desc??''); ?></option>
                ...
                calendar icon and -->
                  ...
                  <div class="tab-pane fade" id="transportation" role="tabpanel" aria-labelledby="transport-tab">
                     <form role="form" id="form_transport_details" action="<?php echo e(Route('search-transportation')); ?>" method="get">
                                 ...
                                 <select class="form-control" name="route_from" id="route_from" required>
                                    ...
                                    <?php $__currentLoopData = $transportation_routes_from; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transportation_route_from): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <option value="<?php echo e($transportation_route_from->RouteFrom); ?>"
                                               <?php if($transportation_route_from->RouteFrom=='Karbala'): ?>
                                               selected
                                               <?php endif; ?>><?php echo e($transportation_route_from->RouteFrom); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 </select>
                              </div>
                           </div>
                                 ...
                                 <select class="form-control" name="route_to" id="route_to" required disabled="true">
                                    ...
                                    <?php $__currentLoopData = $transportation_routes_to; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transportation_route_to): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <option value="<?php echo e($transportation_route_to->RouteTo); ?>"
                                               <?php if($transportation_route_to->RouteTo=='Najaf'): ?>
                                               selected
                                               <?php endif; ?>><?php echo e($transportation_route_to->RouteTo); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 </select>
                              </div>
                           </div>
                           ...
                           <div class="col-md-12">
                              <div class="input-group" id="pickup-date">
                                 ...
                                 <div class="input-group input-daterange">
                                    <input type="date" id="start" class="form-control text-left mr-2" value="<?php echo e(Date('Y-m-d')); ?>" min="<?php echo e(Date('Y-m-d', strtotime('+1 day'))); ?>">
                                 </div>
                              </div>
                           </div>
                  ...
                  <div class="tab-pane" id="guide"  role="tabpanel" aria-labelledby="transport-tab">
                     ...
                     <form method="get" action="<?php echo e(route('guide')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="form-row">
                           <div class="form-group col-md-12">
                              <div class="input-group" id="pickup-date">
                                 <label for=""><i class="fas fa-calendar-alt"></i></label>
                                  ...
                                  ?>
                                 <input type="text" name="daterange" min="<?php echo e($tour_start_date); ?>" value="<?php echo e($tour_start_date); ?> - <?php echo e($tour_end_date); ?>" class="form-control" />
                              </div>
                           </div>
                           <div class="form-group col-md-12">
                              <div class="input-group" id="loc-from">
                                 ...
                                 <select class="form-control" name="city" required>
                                    ...
                                    <option value="karbala"><?php echo e(ucfirst('karbala')); ?></option>
                                    <option value="najaf"><?php echo e(ucfirst('najaf')); ?></option>
                                    <option value="kadhmain"><?php echo e(ucfirst('kadhmain')); ?></option>
                                    <option value="baghdad"><?php echo e(ucfirst('baghdad')); ?></option>
                                    <option value="samarrah"><?php echo e(ucfirst('samarrah')); ?></option>
                           ...
                           <div class="form-group col-md-12">
                              <div class="input-group" id="loc-from">
                                 ...
                                 <select class="form-control" name="language" required>
                                    ...
                                    <option value="english"><?php echo e(ucfirst('english')); ?></option>
                                    <option value="arabic"><?php echo e(ucfirst('arabic')); ?></option>
                                    <option value="urdu"><?php echo e(ucfirst('urdu')); ?></option>
                                    <option value="farsi"><?php echo e(ucfirst('farsi')); ?></option>
                  ...
                  <div class="tab-pane" id="guestspasses">
                     <form method="get" action="<?php echo e(route('searchguestpass')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="form-row">
                           <div class="form-group col-md-12">
                              <div class="input-group" id="loc-from">
                  ...
                  <div class="tab-pane fade" id="hotels" role="tabpanel" aria-labelledby="contact-tab">
                     <form method="get" action="<?php echo e(route('search-hotels')); ?>">
                        <div class="form-row">
                           <div class="form-group col-md-12">
                              <div class="input-group" id="loc-from">
                                 <label for=""><i class="fas fa-map-marker-alt"></i></label>
                                 <select class="form-control" name="destination" required>
                                    ...
                                    <?php $__currentLoopData = $cityNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cityName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <option value="<?php echo e($cityName->GuestPassLocation); ?>" <?php if( $cityName->GuestPassLocation=='Karbala'): ?> selected <?php endif; ?>><?php echo e($cityName->GuestPassLocation); ?> </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 </select>
                              </div>
                           </div>
            ...
            <div class="col-md-12 col-lg-6 banner_text" data-aos="fade-left" data-aos-duration="3000">
               <h2><?php echo ($pages->where('slug','alzuwar')->first()->title??'Not Available'); ?>

               </h2>
               <?php echo ($pages->where('slug','alzuwar')->first()->description??'Not Available'); ?>

               <a href="<?php echo e(route('aboutus')); ?>">Discover More &nbsp;<i class="fas fa-arrow-right"></i></a>
            </div>
         </div>
      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-4 col-md-4" data-aos="fade-right" data-aos-duration="2000">
               <div class="media">
                  <div class="browse_travel">
                     <img src="<?php echo e(asset('website')); ?>/img/browsing.png" alt="">
                  </div>
            ...
            <div class="col-lg-4 col-md-4" data-aos="fade-down" data-aos-duration="2000">
               <div class="media">
                  <div class="browse_travel">
                     <img src="<?php echo e(asset('website')); ?>/img/select1.png" alt="">
                  </div>
                  <div class="media-body">
            ...
            <div class="col-lg-4 col-md-4" data-aos="fade-left" data-aos-duration="2000">
               <div class="media">
                  <div class="browse_travel">
                     <img src="<?php echo e(asset('website')); ?>/img/passport.png" alt="">
                  </div>
                  <div class="media-body">
      ...
      <div class="container">
         <div class="row align-items-center">
            <div class="col-lg-6 Alziyara" data-aos="fade-right" data-aos-duration="3000">
               ...
               <h3><?php echo e(($pages->where('slug','indexabout')->first()->title??'Not Available')); ?></h3>
               <?php echo ($pages->where('slug','indexabout')->first()->description??'Not Available'); ?>

            </div>
            <div class="col-lg-6" data-aos="fade-left" data-aos-duration="3000">
               <img src="<?php echo e(asset('website')); ?>/<?php echo e(($pages->where('slug','indexabout')->first()->image??'Not Available')); ?>" alt="Quran" class="img-fluid">
            </div>
         </div>
      </div>
   </section>
      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-12 text-center Umrah-Package" data-aos="zoom-in" data-aos-duration="3000">
               ...
               <h1><?php echo ($pages->where('slug','ExclusivePackageDeals')->first()->title??'Not Available'); ?></h1>
               <?php echo ($pages->where('slug','ExclusivePackageDeals')->first()->description??'Not Available'); ?>
         ...
         <div class="row">
            <div class="col-md-12 ball_button text-center">
               <a href="<?php echo e(route('packages')); ?>">VIEW ALL PACKAGES &nbsp;<i class="fas fa-arrow-right"></i></a>
            </div>
         </div>
      </div>
   </section>
...
<?php if(sizeof($guestpass)>0): ?>
   <section class="sec-4">
      <div class="container">
         <div class="row">
            <div class="col-lg-12 text-center Umrah-Package" data-aos="zoom-in" data-aos-duration="3000">
               <p class="blue_text"> Experience the variety of </p>
               <h1> <?php echo ($pages->where('slug','GuestProgram')->first()->title??'Not Available'); ?></h1>
                  <?php echo ($pages->where('slug','GuestProgram')->first()->description??'Not Available'); ?>
                        ...
                        <div class="swiper-slide" data-aos="fade-right" data-aos-duration="2000">
                              ...
                              <div class="card-body">
                                 <div class="card_body_content">
                                             ...
                                             <h3 class="card-title"> <?php echo e($gp->GuestPassName); ?></h3>
                                 </div>
         ...
         <div class="row">
            <div class="col-md-12 ball_button text-center">
               <a href="<?php echo e(route('guestspasses')); ?>">VIEW ALL GUEST PASSES &nbsp;<i class="fas fa-arrow-right"></i></a>
            </div>
         </div>
      </div>
   </section>
<?php endif; ?>
      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-6 col-xl-6 text-left" data-aos="fade-right" data-aos-duration="2000">
               <h2> <?php echo e($tourtrips->title??''); ?></h2>
                <?php echo $tourtrips->description??''; ?>

            </div>

            <div class="col-xl-6 col-lg-6" data-aos="fade-left" data-aos-duration="2000">
               <div class="Ziyarat_tours">
                  <img src="<?php echo e(asset('website')); ?>/<?php echo e($tourtrips->image??''); ?>" alt="Quran" class="img-fluid">
                  <div class="tour_content">
                     <h4><?php echo $tourtrips->name??''; ?></h4>
                     <p>
                        <?php for( $a=1 ; $a <= round($tourtrips->rating) ; $a++ ): ?>
                            <i class="fas fa-star"></i>
                        <?php endfor; ?>
                        <?php for( $a=1 ; $a <= 5-round($tourtrips->rating) ; $a++ ): ?>
                            <i class="far fa-star"></i>
                        <?php endfor; ?>
                     </p>
                  </div>
         ...
         <div class="row">
            <?php $__currentLoopData = $tourtrips_lower; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e($item->links??''); ?>">
            <div class="col-lg-4 col-xl-4 col-md-4" data-aos="zoom-in-right" data-aos-duration="2000">
               <div class="Ziyarat">
                  <img src="<?php echo e(asset('website')); ?>/<?php echo e($item->image??''); ?>" alt="Quran" class="img-fluid">
                  <div class="tour_content">
                     <h4><?php echo e($item->name??''); ?></h4>
                     <p>
                        <?php for( $a=1 ; $a <= round($item->rating) ; $a++ ): ?>
                            <i class="fas fa-star"></i>
                        <?php endfor; ?>
                        <?php for( $a=1 ; $a <= 5-round($item->rating) ; $a++ ): ?>
                            <i class="far fa-star"></i>
                        <?php endfor; ?>
                     </p>
                  </div>
            ...
            <!-- <div class="col-lg-4 col-xl-4 col-md-4" data-aos="zoom-in" data-aos-duration="2000">
               <div class="Ziyarat">
                  <img src="<?php echo e(asset('website')); ?>/img/image3.png" alt="Quran" class="img-fluid">
                  <div class="tour_content">
            ...
            <div class="col-lg-4 col-xl-4 col-md-4" data-aos="zoom-in-left" data-aos-duration="2000">
               <div class="Ziyarat">
                  <img src="<?php echo e(asset('website')); ?>/img/image4.png" alt="Quran" class="img-fluid">
                  <div class="tour_content">
                     <h4> Iraq Ziyarat & Tours </h4>
                     <i class="fa fa-star" aria-hidden="true"></i>
                     <i class="fa fa-star" aria-hidden="true"></i>
   ...
   <section class="sec_booking">
      <div class="container-fluid">
         <div class="row">
            <!-- <div class="row"> -->
               <?php $__currentLoopData = $discovers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <div class="col-lg-6 col-xl-4 col-md-6 col-sm-12" data-aos="zoom-in" data-aos-duration="2000">
                  <div class="Exclusive_Prices">
                     ...
                     <div class="Discover_Book">
                        ...
                        <a href="<?php echo e($item->link); ?>"><span><?php echo e($item->title_link??''); ?></span><i class="fas fa-arrow-right"></i></a>
                     </div>
                  </div>
               </div>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               ...
               <!-- <div class="col-lg-4 col-xl-4 col-md-4" data-aos="zoom-in" data-aos-duration="2000">
                  <div class="Exclusive_Prices">
                     <img src="<?php echo e(asset('website')); ?>/img/bus.png" alt="Quran" class="img-fluid">
                     <div class="Discover_Book">
                        <h2> Book Transport at Exclusive Prices </h2>
                        <a href="<?php echo e(route('Transport')); ?>"><span>DISCOVER TRANSPORTATION</span><i class="fas fa-arrow-right"></i></a>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-lg-4 col-xl-4 col-md-4" data-aos="zoom-in" data-aos-duration="2000">
                  <div class="Exclusive_Prices">
                     <img src="<?php echo e(asset('website')); ?>/img/ira.png" alt="Quran" class="img-fluid">
                     <div class="Discover_Book">
                        <h2> Discover Our Tours at Exclusive Prices </h2>
                        <a href="<?php echo e(route('packages')); ?>"><span>DISCOVER TOURS</span><i class="fas fa-arrow-right"></i></a>
                     </div>
                  </div>
               </div> -->
            <!-- </div> -->
      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-12 text-center" data-aos="zoom-in" data-aos-duration="2000">
               ...
               <?php echo ($pages->where('slug','sayaboutus')->first()->description??'Not Available'); ?>
         ...
         <div class="row">
            ...
            <div class="col-lg-6 col-xl-6 col-md-6" data-aos="fade-right" data-aos-duration="2000">
               ...
               <div class="picture_review">
                  <img src="<?php echo e(asset('website')); ?>/img/Ellipse 11.png" alt="Quran" class="img-fluid">
      ...
      <div class="container">
         ...
         <div class="row">
            <div class="col-lg-12 col-xl-12 col-md-12 text-center news_text" data-aos="zoom-in"
               ...
               <h2><?php echo ($pages->where('slug','newsandblogs')->first()->title??'Not Available'); ?></h2>
               <?php echo ($pages->where('slug','newsandblogs')->first()->description??'Not Available'); ?>
         ...
         <div class="row">
            <!-- <div class="col-lg-5 col-xl-5 first_blog" data-aos="fade-right" data-aos-duration="2000">
               <div class="card">
                  <img class="card-img-top" src="<?php echo e(asset('website')); ?>/img/Mask7.png" alt="Card image cap">
            ...
            <div class="col-lg-12 col-xl-12 second_blog">
               <div class="row">
                  ...
                  <div class="col-lg-4 col-xl-3 col-md-6  inner_blog" data-aos="zoom-in" data-aos-duration="2000">
                     <div class="card">
                        <a href="<?php echo e(route('view-blog')); ?>/<?php echo e($item->id??''); ?>">
                        <img class="card-img-top" src="<?php echo e(asset('website')); ?>/<?php echo e($item->image??''); ?>" alt="Card image cap">
                        </a>
                        <div class="row">
                           <p class="col-6 text-center"><i class="far fa-calendar-alt"></i> <?php echo e(\Carbon\Carbon::parse( $item->created_at??'' )->toFormattedDateString()); ?></p>
                  ...
                  <!-- <div class="col-lg-6 col-xl-6 inner_blog" data-aos="zoom-in" data-aos-duration="2000">
                     <div class="card">
                        <img class="card-img-top" src="<?php echo e(asset('website')); ?>/img/Mask9.png" alt="Card image cap">
                        <div class="date_comments">
                           <p><i class="far fa-calendar-alt"></i> 4th Jun 2021 </p>
                           <p><i class="fas fa-comments"></i> 3 comments </p>
                        </div>
               ...
               <!-- <div class="row blog_second_row">
                  <div class="col-lg-6 col-xl-6 inner_blog" data-aos="zoom-in" data-aos-duration="2000">
                     <div class="card">
                        <img class="card-img-top" src="<?php echo e(asset('website')); ?>/img/Mask10.png" alt="Card image cap">
                        <div class="date_comments">
                           <p><i class="far fa-calendar-alt"></i> 4th Jun 2021 </p>
                           <p><i class="fas fa-comments"></i> 3 comments </p>
                        </div>
                  ...
                  <div class="col-lg-6 col-xl-6 inner_blog" data-aos="zoom-in" data-aos-duration="2000">
                     <div class="card">
                        <img class="card-img-top" src="<?php echo e(asset('website')); ?>/img/Mask11.png" alt="Card image cap">
                        <div class="date_comments">
                           <p><i class="far fa-calendar-alt"></i> 4th Jun 2021 </p>
                           <p><i class="fas fa-comments"></i> 3 comments </p>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('website.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/democustompro/public_html/laravel/alzuwar/alziyara_main_files/resources/views/website/index.blade.php ENDPATH**/ ?>