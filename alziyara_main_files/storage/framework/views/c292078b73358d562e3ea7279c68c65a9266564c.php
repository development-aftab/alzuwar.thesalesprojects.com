...
<script type="text/javascript">
    ...
    $('#calendar').fullCalendar({
        ...
        events: [
                ...
                <?php $__currentLoopData = $guidebooking; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ourguidebooking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            {



                <?php if(( $ourguidebooking->BookingStatus == 'CONFIRMED' ) && ($ourguidebooking->PaymentStatus == 'PAID' ) && ($ourguidebooking->request_refund_reply == '' ) ): ?>

                //PAID //CONFIRMED // request_refund == null Green color


                title:   '<?php echo e($ourguidebooking->ReceiptNum??"Not Available"); ?>/<?php echo e($ourguidebooking->getGuidesUserDetail->name??''); ?>',
                start:   '<?php echo e($ourguidebooking->reservation_start_date); ?>',
                ...
                id:      	'<?php echo e($ourguidebooking->ReceiptNum??""); ?>',
                comment: 	'<?php echo e($ourguidebooking->SPComments); ?>',
                color: 		'#2ecc71',
                textColor: 	'white',


                <?php elseif(($ourguidebooking->BookingStatus == 'PENDING')): ?>
                ...
                <?php elseif((($ourguidebooking->BookingStatus == 'CANCELLED') || ($ourguidebooking->PaymentStatus == 'UNPAID')) && ($ourguidebooking->request_refund_reply == '')): ?>
...
<script>
    $(document).on('click','.fc-content',function(e){
        $.get('<?php echo e(URL::to("get-guide-invoice")); ?>/'+$(this).find('span.fc-title').text(),function(data){
            console.log(data);
            $('#insurance').hide();
            $('#donation').hide();
...
<script>
    $(document).on('click','#tour',function(e){
        ...
        location.href = "<?php echo e(url('guide-details/')); ?>/"+id+'/'+name;
    });
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/democustompro/public_html/laravel/alzuwar/alziyara_main_files/resources/views/superadminviews/guidecalender.blade.php ENDPATH**/ ?>