...
<script type="text/javascript">
    $('#calendar').fullCalendar({
        ...
        events: [
                ...
                <?php $__currentLoopData = $roombooking; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ourroombooking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            {


                <?php if(( $ourroombooking->BookingStatus == 'CONFIRMED' ) && ($ourroombooking->PaymentStatus == 'PAID' ) && ($ourroombooking->request_refund_reply == '' ) ): ?>
                //PAID //CONFIRMED // request_refund == null Green color
                title:   '<?php echo e($ourroombooking->ReceiptNum??"Not Available"); ?>/<?php echo e($ourroombooking->getRoomtUserDetail->name??''); ?>',
                start:   '<?php echo e($ourroombooking->checkin); ?>',
                ...
                id:      '<?php echo e($ourroombooking->ReceiptNum??""); ?>',
                comment: '<?php echo e($ourroombooking->SPComments); ?>',
                color: 	'#2ecc71',
                textColor: 'white',

                <?php elseif(( $ourroombooking->BookingStatus == 'PENDING' ) && ($ourroombooking->request_refund_reply == '' ) ): ?>
                ...
                <?php elseif((( $ourroombooking->BookingStatus == 'CANCELLED' ) || ($ourroombooking->PaymentStatus == 'UNPAID' )) && ($ourroombooking->request_refund_reply == '' )): ?>
...
<script>
    $(document).on('click','.fc-content',function(e){
        $.get('<?php echo e(URL::to("get-room-invoice")); ?>/'+$(this).find('span.fc-title').text(),function(data){
            console.log(data);
            $('#donation').hide();
            $('#insurance').hide();
...
//            $("#sub_total").text(result);
    ...
    $(document).on('click','#room',function(e){
        ...
        location.href = "<?php echo e(url('hotelsdetails/')); ?>/"+id+'/'+name;
    });
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/democustompro/public_html/laravel/alzuwar/alziyara_main_files/resources/views/superadminviews/roomcalender.blade.php ENDPATH**/ ?>