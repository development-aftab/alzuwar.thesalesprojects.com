...
<head>
    ...
    <title>Service Provider Activated</title>
...
<div role="article" aria-label="An email from AlZuwar" lang="en" style="background-color: white; color: #2b2b2b; font-family: 'Avenir Next', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px; font-weight: 400; line-height: 28px; margin: 0 auto; max-width: 600px; padding: 40px 20px 40px 20px;">
    ...
    <header>
        ...
        <a href="<?php echo e(route('index')); ?>">
            <center><img src="<?php echo e(asset('website/img/alziyara_white_background_logo.png')); ?>" alt="AlZuwar.com" style="height: auto; width: 90px"></center>
        </a>
    ...
    <main>
        ...
        <div style="background-color: ghostwhite; border-radius: 4px; padding: 24px 48px;">
            ...
            <!-- Body copy -->
            <p>
                Your Account has been successfully activated. You can now log in using the username and password you chose during the registration. Just press the link below.
            </p>
            ...
            <a href="<?php echo e(route('user-login')); ?>" style="color: #B200FD; text-decoration: underline;">Login</a>

            <p>
                If that doesn't work, copy and paste the following link in your browser:
                <br />
                <br />
                <a href="<?php echo e(route('user-login')); ?>" style="color: #B200FD; text-decoration: underline;"><?php echo e(route('user-login')); ?></a>
            </p>
            <p>
    ...
    <footer>
        ...
        <p style="font-size: 16px; font-weight: 400; line-height: 24px; margin-top: 48px;">
            You received this email because your email was used in creating a profile at <strong><a href="<?php echo e(route('index')); ?>">AlZuwar.com</a></strong>
        </p>
        ...
        <!-- <strong><a href="https://{servername}">{servername}</a></strong> 1234 Main Street, Anywhere, US 56789 -->
        <!-- </address> -->
    </footer>
...
</html><?php /**PATH /home2/democustompro/public_html/laravel/alzuwar/alziyara_main_files/resources/views/mail/activate_account.blade.php ENDPATH**/ ?>