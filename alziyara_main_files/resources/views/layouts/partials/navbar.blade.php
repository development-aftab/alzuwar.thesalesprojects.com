<nav class="navbar navbar-default navbar-static-top m-b-0">
    <div class="navbar-header">
        ...
        <div class="top-left-part">
            {{--<a class="logo" href="{{'/'}}">--}}
                {{--<b>--}}
                    {{--<img src="{{asset('website/img/alziyara_white_background_logo.png')}}" style="height: 50px;" alt="home"/>--}}
                {{--</b>--}}
                {{--<span>--}}
                    {{--<img src="{{asset('website/img/logo-text.png')}}" alt="homepage" class="dark-logo"/>--}}
                {{--</span>--}}
            {{--</a>--}}
        </div>
