        ...
        {{--<div class="row colorbox-group-widget">--}}
                ...
                {{--<div class="white-box">--}}
                    {{--<div class="media bg-success">--}}
                        {{--<div class="media-body">--}}
                            {{--<h3 class="info-count">${{$total_sales*0.8??0}}--}}
                                {{--<span class="pull-right text-right">--}}
                                {{--<div class="container">--}}
                                {{--<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#form">Withdraw Amount Request</button>--}}
                                {{--</div>--}}
                                {{--</span>--}}
                            {{--</h3>--}}
            ...
            {{--<div class="col-md-4 col-sm-6 info-color-box">--}}
                {{--<div class="white-box">--}}
                    {{--<div class="media bg-success">--}}
                        {{--<div class="media-body">--}}
                            {{--<h3 class="info-count">${{$wthdrawed_amount*0.8??0}}--}}
                                {{--<span class="pull-right text-right">--}}
                                {{--<div class="container">--}}
                                {{--<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#form">Withdraw Amount Request</button>--}}
                                {{--</div>--}}
                                {{--</span>--}}
                            {{--</h3>--}}
                            {{--<p class="info-text font-12">Withdrawed Amount</p>--}}
                            {{--<!--<p class="info-ot font-15">Closed<span class="label label-rounded">0</span></p>-->--}}
                        {{--</div>--}}
                    {{--</div>--}}
                {{--</div>--}}
            ...
            {{--<div class="col-md-4 col-sm-6 info-color-box">--}}
                {{--<div class="white-box">--}}
                    {{--<div class="media bg-success">--}}
                        {{--<div class="media-body">--}}
                            {{--<h3 class="info-count">${{($total_sales*0.8)-($wthdrawed_amount*0.8)??0}}--}}
                                {{--<span class="pull-right text-right">--}}
								{{--<div class="">--}}
									{{--<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#form">Withdraw Amount Request</button>--}}
								{{--</div>--}}
							{{--</span>--}}
                            {{--</h3>--}}
                            {{--<p class="info-text font-12">Remaining Amount</p>--}}
                            {{--<!--<p class="info-ot font-15">Closed<span class="label label-rounded">0</span></p>-->--}}
                        {{--</div>--}}
                    {{--</div>--}}
                {{--</div>--}}
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{route('withdraw-request-accept-reject')}}">
                            @csrf()
                            <input type="hidden" name="category_id" class="form-control" id="category_id" value="2">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box sales_chart_border">
                    ...
                    <hr>
                {{--<h3 class="box-title m-b-0">My Rooms Reservations</h3>--}}
                            ...
                            @foreach($roompassreserves as $key => $roomreserve)
                                @if(isset($roomreserve->getRoomOrderssupadmin))
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                @if ($roomreserve->BookingStatus == 'PENDING')
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('room_invoice/' . $roomreserve->ReservationID??'') }}" title="Order Details">
