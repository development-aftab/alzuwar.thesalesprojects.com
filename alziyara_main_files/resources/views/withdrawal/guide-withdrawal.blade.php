            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('withdraw-request-accept-reject')}}">
                        @csrf()
                        <input type="hidden" name="category_id" class="form-control" id="category_id" value="5">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="white-box sales_chart_border">
                    <h3 class="box-title pull-left">Withdrawal Request - Guide</h3>
                    <div class="pull-right">
                    </div>
                    <div class="clearfix"></div>
                    <hr>
                {{--<h3 class="box-title m-b-0">My Guide Reservations</h3>--}}
...
{{--                                @if(isset($myguide->getGuideOrderssupadmin))--}}
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                @if ($myguide->BookingStatus == 'PENDING')
