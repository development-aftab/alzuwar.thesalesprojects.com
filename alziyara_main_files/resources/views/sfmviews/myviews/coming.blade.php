...
<body>
   <section id="banner-sec">
      <div class="container">
         <div class="align-items-center d-flex hero-section row">
            ...
            <div class="col-lg-6 col-md-6">
               <div class="hero-img pl-5">
                  <img class="img-fluid" src="./images/c31.png" alt="">
               </div>
            </div>
         </div>
      </div>
   ...
   <section id="home-sec-3" class="coming-sec3">
      <div class="container">
         <div class="row d-flex align-items-center">
            ...
            <div class="col-lg-6 col-md-6 h-in-col">
               <div class="image-container">
                  <img class="img-fluid" src="./images/c3.png" alt="">
               </div>
            </div>
            <div class="col-lg-6 col-md-6">
   ...
   <div class="row pt-5 mt-5">
            ...
            <div class="col-lg-6 col-md-6 h-in-col">
               <div class="image-container">
                  <img class="img-fluid" src="./images/c44.png" alt="">
               </div>
            </div>
            </div>
         </div>
