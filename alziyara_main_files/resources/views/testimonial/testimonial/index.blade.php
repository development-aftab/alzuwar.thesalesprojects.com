        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box sales_chart_border">
                    <h3 class="box-title pull-left">Testimonials</h3>
                        ...
                        <table class="table" id="myTable">
                            ...
                            @foreach($testimonial as $item)
                                <tr>
                                    ...
                                    <td>{!! substr($item->description, 0, 127) . '...'  !!}</td><td>{{ $item->name }}</td><td>{{ $item->rating }}</td>
                                    <td>
                                        @can('view-'.str_slug('Testimonial'))
                                            <a href="{{ url('/testimonial/testimonial/' . $item->id) }}"
                                        ...
                                        @can('edit-'.str_slug('Testimonial'))
                                            <a href="{{ url('/testimonial/testimonial/' . $item->id . '/edit') }}"
                                        ...
                                        @can('delete-'.str_slug('Testimonial'))
                                            <form method="POST"
                                                  action="{{ url('/testimonial/testimonial' . '/' . $item->id) }}"
