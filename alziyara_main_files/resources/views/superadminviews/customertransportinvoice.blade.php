                ...
                <div class="row">
                    ...
                    {{--<div class="row">--}}
                        ...
                        {{--<div class="col-md-4 text-center">--}}
                            {{--@if($transportreserves->TypeofPayment == "cashpayment" || $transportreserves->TypeofPayment == "bankpayment" || $transportreserves->TypeofPayment == "zelle")--}}
                                {{--@if ($transportreserves->PaymentStatus == 'PAID')--}}
