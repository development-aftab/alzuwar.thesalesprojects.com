                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="pull-left">
                            <address>
                                ...
                                <p class="m-l-5 duration_day">Duration: <b>{{$noOfDays??''}}</b></p>
                                </p>
                            </address>
                        </div>
                    ...
                    {{--<div class="row">--}}
                        ...
                        {{--<div class="col-md-4 col-sm-12 text-center col-offset-2">--}}
                            ...
                            {{--@elseif($roomreserves->TypeofPayment == "cashpayment" || $roomreserves->TypeofPayment == "bankpayment" || $roomreserves->TypeofPayment == "zelle")--}}
                                {{--@if ($roomreserves->PaymentStatus == 'PAID')--}}
                        ...
                        {{--<div class="col-md-4 col-sm-12 text-left col-offset-2">--}}
                            ...
                            {{--@elseif($roomreserves->booking_status == 'PENDING')($roomreserves->BookingStatus == 'PENDING')--}}
                            {{--<p style='cursor:pointer; color:darkorange;'><b>Booking Status:</b>PENDING</p>--}}
                            {{--@elseif($roomreserves->BookingStatus == 'CANCELLED')--}}
                                {{--<p style='cursor:pointer;'><b>Booking Status:</b><span style="color:orangered;"> CANCELLED</span> </p>--}}
                            {{--@else--}}
                                {{--<p style='cursor:pointer;'><b>Booking Status:</b><span style="color: green;"> CONFIRMED</span></p>--}}
                            {{--@endif--}}
                        {{--</div>--}}
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive m-t-40" style="clear: both;">
                            <table class="table table-hover re_table">
                                ...
                                <tbody>
                                <tr>
                                    <td ><a href="{{url('hotelsdetails/'.$roomreserves->getReservationOrdersroom->getHotelRoomDetails->PropertyID??''.'/'.$roomreserves->getReservationOrdersroom->getHotelRoomDetails->Name??'')}}" target="_blank">{{ $roomreserves->getReservationOrdersroom->RoomType??'' }}</a></td>
