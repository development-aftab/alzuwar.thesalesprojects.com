                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="white-box printableArea">
                                    <div class="pull-left">
                                    <p><img src="{{ asset('website') }}/img/alziyara_white_background_logo.png" alt="Logo" style="height: 120px;"><b style="margin-left: 20px"><a>ALZUWAR.COM</a></b></p>
                                    </div>
            ...
            events: [
                ...
                @foreach($guestpassbooking as $ourguestpassbooking)
                   {	
                        ...
                        color: 		'#2ecc71',
                        textColor: 	'white',
						{{--@elseif(( $ourguestpassbooking->BookingStatus == 'CONFIRMED' ) && ($ourguestpassbooking->PaymentStatus == 'UNPAID' ) && ($ourguestpassbooking->request_refund_reply == '' ) )--}}
						{{----}}
						{{--//UNPAID //CONFIRMED // request_refund == null Silver color--}}
							{{----}}
						{{--title:   	'{{$ourguestpassbooking->ReceiptNum??"Not Available"}}/{{$ourguestpassbooking->getGuestPassOrdersbyuser->name??''}}',--}}
                        {{--start:   	'{{$ourguestpassbooking->ReservationForDate}}',--}}
                        {{--id:      	'{{$ourguestpassbooking->ReservationID??""}}',--}}
                        ...
                        color: 		'#ff0000',
                        textColor: 	'white',
						{{--@elseif(( $ourguestpassbooking->BookingStatus == 'CANCELLED' ) && ($ourguestpassbooking->PaymentStatus == 'PAID' ) && ($ourguestpassbooking->request_refund_reply == '' ) )--}}
						{{----}}
						{{--//PAID //CANCELLED // request_refund == null Lime color--}}
							{{----}}
						{{--title:   	'{{$ourguestpassbooking->ReceiptNum??"Not Available"}}/{{$ourguestpassbooking->getGuestPassOrdersbyuser->name??''}}',--}}
                        {{--start:   	'{{$ourguestpassbooking->ReservationForDate}}',--}}
                        {{--id:      	'{{$ourguestpassbooking->ReservationID??""}}',--}}
                        ...
                        {{--textColor: 	'white',--}}
						{{----}}
						{{--@elseif(( $ourguestpassbooking->BookingStatus == 'PENDING' ) && ($ourguestpassbooking->PaymentStatus == 'PAID') && ($ourguestpassbooking->request_refund_reply == 'REFUNDED' ) )--}}
						{{----}}
						{{--//PAID //PENDING // request_refund == REFUNDED yellow color--}}
							{{----}}
						{{--title:   	'{{$ourguestpassbooking->ReceiptNum??"Not Available"}}/{{$ourguestpassbooking->getGuestPassOrdersbyuser->name??''}}',--}}
                        {{--start:   	'{{$ourguestpassbooking->ReservationForDate}}',--}}
                        {{--id:      	'{{$ourguestpassbooking->ReservationID??""}}',--}}
                        ...
                        {{--textColor: 	'black',--}}
						{{----}}
						{{--@elseif(( $ourguestpassbooking->BookingStatus == 'CONFIRMED' ) && ($ourguestpassbooking->PaymentStatus == 'PAID' ) && ($ourguestpassbooking->request_refund_reply == 'REFUNDED' ) )--}}
						{{----}}
						{{--//PAID //CONFIRMED // request_refund == REFUNDED Aqua color--}}
							{{----}}
						{{--title:   	'{{$ourguestpassbooking->ReceiptNum??"Not Available"}}/{{$ourguestpassbooking->getGuestPassOrdersbyuser->name??''}}',--}}
                        {{--start:   	'{{$ourguestpassbooking->ReservationForDate}}',--}}
                        {{--id:      	'{{$ourguestpassbooking->ReservationID??""}}',--}}
						...
						{{----}}
						{{----}}
						{{--@elseif(( $ourguestpassbooking->BookingStatus == 'CONFIRMED' ) && ($ourguestpassbooking->PaymentStatus == 'PAID' ) && ($ourguestpassbooking->request_refund_reply == 'CANCELLED' ) )--}}
						{{----}}
						{{--//PAID //CONFIRMED // request_refund == CANCELLED Teal color--}}
							{{----}}
						{{--title:   	'{{$ourguestpassbooking->ReceiptNum??"Not Available"}}/{{$ourguestpassbooking->getGuestPassOrdersbyuser->name??''}}',--}}
                        {{--start:   	'{{$ourguestpassbooking->ReservationForDate}}',--}}
                        {{--id:      	'{{$ourguestpassbooking->ReservationID??""}}',--}}
                        ...
                        {{--textColor: 	'white',--}}
						{{----}}
						{{--@elseif(( $ourguestpassbooking->BookingStatus == 'PENDING' ) && ($ourguestpassbooking->PaymentStatus == 'PAID' ) && ($ourguestpassbooking->request_refund_reply == 'CANCELLED' ) )--}}
						{{----}}
						{{--//PAID //PENDING // request_refund == CANCELLED Azure color--}}
							{{----}}
						{{--title:   	'{{$ourguestpassbooking->ReceiptNum??"Not Available"}}/{{$ourguestpassbooking->getGuestPassOrdersbyuser->name??''}}',--}}
                        {{--start:   	'{{$ourguestpassbooking->ReservationForDate}}',--}}
                        {{--id:      	'{{$ourguestpassbooking->ReservationID??""}}',--}}
                        ...
                        {{--textColor: 	'white',--}}
						{{----}}
						{{--@elseif(( $ourguestpassbooking->BookingStatus == 'PENDING' ) && ($ourguestpassbooking->PaymentStatus == 'PAID' ) && ($ourguestpassbooking->request_refund_reply == 'REQUESTED' ) )--}}
						{{----}}
						{{--//PAID //PENDING // request_refund == CANCELLED Khaki color--}}
							{{----}}
						{{--title:   	'{{$ourguestpassbooking->ReceiptNum??"Not Available"}}/{{$ourguestpassbooking->getGuestPassOrdersbyuser->name??''}}',--}}
                        {{--start:   	'{{$ourguestpassbooking->ReservationForDate}}',--}}
                        {{--id:      	'{{$ourguestpassbooking->ReservationID??""}}',--}}
                        ...
                        {{--textColor: 	'white',--}}
						{{----}}
						{{--@elseif(( $ourguestpassbooking->BookingStatus == 'CANCELLED' ) && ($ourguestpassbooking->PaymentStatus == 'PAID' ) && ($ourguestpassbooking->request_refund_reply == 'REFUNDED' ) )--}}
						{{----}}
						{{--//PAID //PENDING // request_refund == CANCELLED Brown color--}}
							{{----}}
						{{--title:   	'{{$ourguestpassbooking->ReceiptNum??"Not Available"}}/{{$ourguestpassbooking->getGuestPassOrdersbyuser->name??''}}',--}}
                        {{--start:   	'{{$ourguestpassbooking->ReservationForDate}}',--}}
                        {{--id:      	'{{$ourguestpassbooking->ReservationID??""}}',--}}
