    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <hr>
                {{--<h3 class="box-title m-b-0">Add Hotel/Property</h3>--}}
                {{--<br/>--}}
                ...
                {{csrf_field()}}
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="HotelName" class="form-control" value="{{ old('HotelName') }}" placeholder="Name" required>
						</div>
							...
							<div class="col-md-4">
								<select class="form-control" name="propertytype" required>
									@foreach($data['propertytype'] as $mypropertytype)
										<option value="{{$mypropertytype->PropertyTypeID}}">{{$mypropertytype->PropertyTypeDesc}}</option>
									@endforeach
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" name="HotelCountry" class="form-control" value="{{ old('HotelCountry') }}" placeholder="Country" required>
					...
					{{--<div class="form-group">--}}
                        ...
                        <div class="col-md-4">
                            <input type="number" name="HotelPrice" class="form-control" value="{{ old('Price') }}" placeholder="Price">
						</div>-->
						
						{{--<label class="col-md-2">Hotel/Property Postal Code</label>--}}
                        {{--<div class="col-md-4">--}}
                            {{--<input type="number" name="HotelPostalCode" class="form-control" value="{{ old('HotelPostalCode') }}" placeholder="Postal Code">--}}
					...
					<div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="number" name="HotelDistance" class="form-control" value="{{ old('HotelDistance') }}" required>Km
						</div>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-12">
							...
							<input type="type" name="HotelAddress" class="form-control" value="{{ old('HotelAddress') }}" placeholder="Address" required> </div>
                            
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Hotel/Property Description</label>
                        <div class="col-md-12">
                            <textarea maxlength="1000" max class="form-control" name="HotelDesc"  rows="5" required>{{ old('HotelDesc') }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-12">Hotel/Property HouseRules</label>
                        <div class="col-md-12">
                            <textarea maxlength="1000" class="form-control summerhousehours" name="HotelHouseRules" rows="5" required>{{ old('HotelHouseRules') }}</textarea>
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-12">
                            <textarea maxlength="1000" class="form-control summerhousehours" name="HotelItenaryGeneral" rows="5" required>{{ old('HotelItenaryGeneral') }}</textarea>
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-12">
                            <textarea maxlength="1000" class="form-control summerhousehours" name="HotelItenaryfood_and_drink" rows="5" required>{{ old('HotelItenaryfood_and_drink') }}</textarea>
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-12">
                            <textarea maxlength="1000" class="form-control summerhousehours" name="HotelItenaryfront_desk_services" rows="5" required>{{ old('HotelItenaryfront_desk_services') }}</textarea>
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-12">
                            <textarea maxlength="1000" class="form-control summerhousehours" name="HotelItenaryentertainment_and_family_services" rows="5" required>{{ old('HotelItenaryentertainment_and_family_services') }}</textarea>
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-12">
                            <textarea maxlength="1000" class="form-control summerhousehours" name="HotelItenaryliving_area" rows="5" required>{{ old('HotelItenaryliving_area') }}</textarea>
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-12">
                            <textarea maxlength="1000" class="form-control summerhousehours" name="HotelItenaryhealth_facility" rows="5" required>{{ old('HotelItenaryhealth_facility') }}</textarea>
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-12">
                            <textarea maxlength="1000" class="form-control summerhousehours" name="HotelItenarysafety_and_security" rows="5" required>{{ old('HotelItenarysafety_and_security') }}</textarea>
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-12">
                            <textarea maxlength="1000" class="form-control summerhousehours" name="HotelItenarybussiness_facility"  rows="5" required>{{ old('HotelItenarybussiness_facility') }}</textarea>
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-12">
                            <textarea maxlength="1000" class="form-control summerhousehours" name="HotelItenaryaccessibility"  rows="5" required>{{ old('HotelItenaryaccessibility') }}</textarea>
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-12">
                            <textarea maxlength="1000" class="form-control summerhousehours" name="HotelItenarylanguages_spoken" rows="5" required>{{ old('HotelItenarylanguages_spoken') }}</textarea>
                        </div>
                    </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-12">
                            <textarea maxlength="1000" class="form-control summerhousehours " name="HotelItenarycleaning_service" rows="5" required>{{ old('HotelItenarycleaning_service') }}</textarea>
                        </div>
                    </div>
