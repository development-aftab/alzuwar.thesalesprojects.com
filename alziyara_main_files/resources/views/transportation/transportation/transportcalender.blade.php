...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">Bookings - [Transportation]</h3>
                            ...
                            <div class="col-md-12">
                                <div class="white-box printableArea">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="pull-left">
                                                <p><b>Passenger Name: </b><span class="name" id="name" name="name"></span></p>
                                                <p><b>Service Provider Name: </b><span class="service_provider_name" id="service_provider_name" name="service_provider_name"></span></p>
                                                <p><b>Driver Name: </b><span class="driver_name" id="driver_name" name="driver_name"></span></p>
                                                <p><b>Pickup: </b><span class="pickup" id="pickup" name="pickup"></span></p>
                                                <p><b>DropOff: </b><span class="dropoff" id="dropoff" name="dropoff"></span></p>
                                                <p><b>Trip Start Date: </b><span class="transport_start_date" id="transport_start_date" name="transport_start_date"></span></p>
                                                <p><b>Trip End Date: </b><span class="transport_end_date" id="transport_end_date" name="transport_end_date"></span></p><p><b>Participants: </b><span class="participants" id="participants" name="participants"></span></p>
                                            ...
                                            <div class="table-responsive m-t-40" style="clear: both;">
                                                <table class="table table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="text-center">Vehicle Number Plate</th>
                                                        <th class="text-center">Passengers</th>
                                                        <th class="text-center">Seats</th>
                                                        <th class="text-center">Suitcases</th>
                                                        <th class="text-center">Suitcase Capacity</th>
                                                    ...
                                                    <tbody>
                                                    <tr>
                                                        <td class="text-center">  <span id="vehicle_name"></span></td>
                                                        <td class="text-center">  <span id="vehicle_description"></span></td>
                                                        <td class="text-center">  <span id="vehicle_number_plate"></span></td>
                                                        <td class="text-center">  <span id="passengers"></span></td>
                                                        <td class="text-center">  <span id="seats"></span></td>
                                                        <td class="text-center">  <span id="suitcase"></span></td>
                                                        <td class="text-center">  <span id="suitcase_capacity"></span></td>
                                                ...
                                                <div class="text-left">
                                                    ...
                                                    <p>•	There are no fees to cancel reservations. However it has to be done 10 days before service day of the receipt - (<label id="transport_start_date_minus"></label>). Contact Alzuwar.com team for any assistance.</p>
                                                    <p>•    We recommend customers and service provider contact each other ahead of time to confirm plans.</p>
                                                    <p>•	No Shows – If service provider (<label id="driver_name_policy"></label>) did not show up or honor the bookings then customer (<label id="name_policy"></label>) should contact alzuwar.com team immediately to provide another alternative service provider.</p>
                                                    <p>•	No Shows – If customer (<label id="name_next"></label>)  did not show up at place of contact then service provider (<label id="driver_name_next"></label>) should call alzuwar.com team immediately to notify.</p>
                                                    <b>House Rules: </b>
                                                    <p id="house_rules"></p>
                                                </div>
                                                <hr>
    ...
    $('#calendar').fullCalendar({
        ...
        events: [
                ...
                @foreach($transportbooking as $ourtransportbooking){
                    @if($ourtransportbooking->getTransportOrders != null)
                        @if($ourtransportbooking->getTransportOrders->TransportationOwnerID == $userDetail->id)
                            @if(( $ourtransportbooking->BookingStatus == 'CONFIRMED') && ($ourtransportbooking->PaymentStatus == 'PAID') && ($ourtransportbooking->request_refund_reply == ''))
                                ...
                                id:      '{{$ourtransportbooking->ReservationID??""}}',
...
<script>
    $('.fc-content').click(function(e){
        $.get('{{ URL::to("get-transport-invoice")}}/'+$(this).find('span.fc-title').text(),function(data){
            ...
            $("#price_per_ticket").text(data['get_transport_orderssupadmin']['Price']||'');
            @if(Auth::user()->hasrole('SuperAdmin'))
            ...
            @else
                $("#price").text(data['get_transport_orderssupadmin']['Price']*1||'');
                $("#sub_total").text(data['get_transport_orderssupadmin']['Price']*1||'');
                $("#total").text(data['get_transport_orderssupadmin']['Price']*1+40||'');
            @endif
