...
<section id="wrapper" class="login-register">
    <div class="login-box">
        <div class="white-box">
            <form class="form-horizontal form-material" id="loginform" method="POST" action="{{ route('usersignup') }}" enctype='multipart/form-data'>
                {{csrf_field()}}
				...
				<div class="form-group ">
					...
					<div class="col-xs-6">
                        <input id="password" type="" class="form-control{{ $errors->has('phoneno') ? ' is-invalid' : '' }}" placeholder="Phone number" value="{{old('phoneno')}}" name="phoneno" required>
						...
						@if ($errors->has('vendorType'))
                            <span class="invalid-feedback">
									<strong>{{ $errors->first('vendorType') }}</strong>
							</span>
                        @endif
				...
				<div class="form-group ">
					<div class="col-xs-12">
						<input id="image" type="file" class="form-control{{ $errors->has('image') ? ' is-invalid' : '' }}" placeholder="Image" name="image" accept="image/png, image/jpg, image/jpeg" required>
