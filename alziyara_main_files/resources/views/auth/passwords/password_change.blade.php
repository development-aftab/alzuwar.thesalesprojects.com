                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="mb-4 icon_position">
                                ...
                                <input placeholder="Email" id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" aria-label="Username" aria-describedby="basic-addon1" name="email" value="{{ $email ?: old('email') }}" required autofocus readonly>
                                @if ($errors->has('email'))
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="mb-4 icon_position">
                                ...
                                <input id="password" placeholder="Password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" aria-label="Username" aria-describedby="basic-addon1" name="password" required>
