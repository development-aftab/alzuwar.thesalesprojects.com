                                        ...
                                        @if(isset($cart["category"]))
                                            ...
                                            @elseif($cart["category"] == 2)
                                                ...
                                                <li class="breadcrumb-item"><a
                                                            href="{{ url()->previous() }}">{{ $cart['title'] }}</a></li>
                                            ...
                                            @elseif($cart["category"] == 5)
                                                ...
                                                <li class="breadcrumb-item"><a href="{{ route('guestspasses') }}">Guide</a>
                                                </li>
                                                <li class="breadcrumb-item"><a
                                                            href="{{ url()->previous() }}">{{ $cart['title'] }}</a></li>
                                                @else
                                    ...
                                    <div class="col-md-8">
                                        <div class="sect-one-txt">
                                            ...
                                            <p class="guest-rating">Guests have rated it
                                                {{ round($categoryitem->getGuestPassreviewdetails->avg('Rating'), 2) }}!
                                            </p>
                                            ...
                                            <div class="reviews">
                                                ...
                                                <p class="reviews-para">
                                                    {{ $categoryitem->getGuestPassreviewdetails->count() }} reviews</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @elseif($cart["category"] == "1")
                                    ...
                                    <div class="col-md-8">
                                        <div class="sect-one-txt">
                                            ...
                                            <div class="reviews">
                                                <h4 class="rating-num">
                                                    {{ round($categoryitem->getPackageReviewAverage[0]->averageRating, 2) }}
                                                    out of 5</h4>
                                                ...
                                                <p class="reviews-para">
                                                    {{ $categoryitem->getPackageReviewCountForView->count() }} reviews</p>
                                            </div>
                                ...
                                @elseif($cart["category"] == "2")
                                    ...
                                    <div class="col-md-8">
                                        <div class="sect-one-txt">
                                            ...
                                            <p class="guest-rating">Guests have rated it
                                                {{ round($categoryitem->getHotelReviewAverage[0]->averageRating, 2) }}!
                                            </p>
                                            ...
                                            <div class="reviews">
                                                ...
                                                <p class="reviews-para">{{ $categoryitem->getHotelReview->count() }}
                                                    reviews</p>
                                            </div>
                                        ...
                                        <div class="sect-one-txt">
                                            ...
                                            <div class="reviews">
                                                ...
                                                @if (count($categoryitem->getTransportReview) > 1)
                                                    <p class="reviews-para">
                                                        {{ count($categoryitem->getTransportReviewForView) }} reviews</p>
                                                @else
                                                    <p class="reviews-para">
                                                        {{ count($categoryitem->getTransportReviewForView) }} review</p>
                                                @endif
                                ...
                                @elseif($cart["category"] == "5")
                                    ...
                                    <div class="col-md-8">
                                        <div class="sect-one-txt">
                                            ...
                                            <p class="guest-rating">Guests have rated it
                                                {{ round($categoryitem->getGuideReviewForView->avg('Rating'), 2) }} !</p>
                                            ...
                                            <div class="reviews">
                                                <h4 class="rating-num">
                                                    {{ round($categoryitem->getGuideReviewForView->avg('Rating'), 2) }}
                                                    out of 5</h4>
                                                ...
                                                <p class="reviews-para">
                                                    {{ $categoryitem->getGuideReviewForView->count() }} reviews</p>
                                            </div>
                                        </div>
                                    </div>
                                @else
                        ...
                        <div class="section-2">
                            <h2 class="person-booking">
                                @if (isset(Auth::user()->id))
                                    ...
                                    <br>
                                    <br>
                                    {{-- <h3>Your Account<span><small><a href="{{ route('profile')}}">Edit</a></small></span> </h3> --}}
                                    <label>
                                        <label>Full Name : <?php $userprofile = App\Profile::where('user_id', '=', Auth::user()->id)->first(); ?> {{ Auth::user()->name }} </label>
                                        <br />
                                        <label>Contact : {{ $userprofile->phone }} </label>
                                        <br />
                                        <label>Email : {{ Auth::user()->email }} </label>
                                        <br />
                                        <label>{{ $userprofile->country }}</label>
                                        <br>
                                    </label>
                                @else
                                    Who is booking?<span class="text-right"><a href="{{ route('user-login') }}">I
                                            already have an account</a></span>
                                @endif
                            </h2>
                            @if (isset(Auth::user()->id))
                                <form action="{{ route('mycheckoutauth') }}" method="POST" name="checkout" id="checkout">

                                    @csrf
                                    @else
                                        <form action="{{ route('registeruser') }}" method="POST" name="checkout"
                                              id="checkout">
                                            @csrf
                                            <div class="form-row for-user-icon">
                                                <div class="form-group col-md-8">
                                                    ...
                                                    <input type="text" name="name" class="form-control" id="inputEmail4"
                                                           value="{{ old('name') }}" required placeholder="First and Last Name"
                                    ...
                                    <span>
                                        <select class="form-control" name="donation_shrine_name">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 text-area">
                                                    ...
                                                    <div class="text-area-bg">
                                                        ...
                                                        <textarea name="customernotes" class="form-control" id="" cols="90" rows="3">{{ old('customernotes') }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="car-info">
                                                ...
                                                @if (isset($cart))
                                                    @if($cart["category"] == "4")
                                                        <h3>Rules, Cancelations & No-Show policy for {{ $cart['title'] }}</h3>
                                                        {{-- <p> ( {{ $cart['title'] }} ) - ( {{ $cart['date'] }} )</p> --}}
                                                        {{-- <li>The following rules and restriction are provided by the Vendor ( <strong>{{$categoryitem->guestpassbyuser->name}} </strong>)</li> --}}
                                            ...
                                            {{-- <script src="https://www.paypal.com/sdk/js?client-id=ATGX5V08SX2b-x7A1TmD0ass9ogvisyzD59ejLD98JUib8dUit2Fa_wxxHJvUumh7OEKtWqxTx76BOZL"> // Replace YOUR_CLIENT_ID with your sandbox client ID</script> --}}
                                                ...
                                                <div class="container">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div id="paypaltab" class="container tab-pane fade"><br>
                                                            ...
                                                            <input id="check" type="checkbox" @if (!Auth::User()) disabled @endif>
                                                            <label id="checkbox-label">Check here to continue payment...</label>
                                                            <script src="https://www.paypal.com/sdk/js?client-id={{ env('PAYPAL_SANDBOX_CLIENT_ID') }}">
                                                                            ...
                                                                            purchase_units: [{
                                                                                amount: {
                                                                                    value: parseFloat(document.getElementById('formtotalamount').value)
                                                                                            .toFixed(2)
                                                                                    {{-- value: '{{number_format($cart['price'], 2, '.', '')}}' --}}
                                                                                }
                                                                            }]
                                                                        });
                                                        ...
                                                        <div id="zelletab" class="container tab-pane fade"><br>
                                                            <h3>Zelle Payment</h3>
                                                            {{-- <ol>
                                                                                <li>Please search us in Zelle by email “info@alziarah.com”</li>
                                                                                <li>Write your phone number and email address on message field and submit payment at Zelle.</li>
                                                                            </ol> --}}
                                                        ...
                                                        after payment has been received.For </span></p>
                                                            ...
                                                            {{-- <p><strong>Note: It can take up to 5 business days to receive and post the payment.</strong></p> --}}
                                                        ...
                                                        <div id="cashtab" class="container tab-pane fade"><br>
                                                            <h3>Cash Payment</h3>
                                                            {{-- <ol>
                                                                                <li>You can visit our office and pay in person. <strong>Please don’t send cash by mail</strong> <br/>Office Address<br/>Ziyarah Inc.<br/>137-11 90th Ave <br/>Jamaica, NY 11435</li>
                                                                            </ol> --}}
                        ...
                        <section class="form-section-modal">
                            <div class="container">
                                ...
                                @if (isset($cart))
                                    ...
                                    @if($cart["category"] == "4")
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                {{--<p class="check-dates">--}}
                                                {{--<?php $mygustspassdate = date_create($cart['date']); ?>{{ date_format($mygustspassdate, 'D, M d, Y ') }}--}}
                                                {{--</p>--}}

                                                @foreach ($categoryitem->getGuestPassprogramDetails as $key => $getGuestPassDetail)
                                                    <p class="time-check">
                                                        <?php $mygustspassdate = date_create($cart['date']); ?>{{ date_format($mygustspassdate, 'D, M d, Y ') }} {{ date('g:iA', strtotime($getGuestPassDetail->GuestProDetailTime)) }}
                                                    </p>
                                    ...
                                    @elseif($cart["category"] == "1")
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <p class="check-dates">{{ date_format($myhotelcheckindate,"D, M d, Y ") }}</p>
                                                <!--<h6 class="time-check">00:00</h6>-->
                                            </div>
                                            <div class="col-md-6">
                                                <h3 class="check-in">To</h3>
                                                <p class="check-dates">{{ date_format($myhotelcheckoutdate,"D, M d, Y ") }}</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 ">
                                                @if($numberDays == 0)
                                                    <p>1 Day</p>
                                                @else
                                                    <p>{{ $numberDays + 1}} Days</p>
                                                @endif
                                            </div>

                                        </div>
                                        {{-- <div class="txt_recipt checkout_date">
                                           <h3>Date:</h3>
                                            <h4 class="date">{{$cart['date']}}</h4>
                                        </div> --}}
                                        {{-- <div class="row">
                                            <div class="col">
                                                <h3 class="length-stay">Total length of stay:</h3>
                                                <h4 class="week-stay">{{$numberDays}} Days</h4>
                                            </div>
                                        </div> --}}
                                    @elseif($cart['category'] == '3')
                                        <?php
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <p class="check-dates">{{ date_format($pickuptime, 'D, M d, Y ') }} {{ date_format($pickuptime, 'h:i a') }}</p>
                                                {{--<p class="time-check"></p>--}}
                                            </div>

                                            {{-- <div class="col-md-6">
                                               <h4 class="check-in">Check-out</h4>
                                                    <h3 class="check-dates">{{ date_format($dropouttime,"D, M d, Y ") }}</h3>
                                                    <h6 class="time-check">{{ date_format($dropouttime,"H:i:s") }}</h6>
                                            </div> --}}
                                        </div>
                                        {{-- <div class="row">
                                           <div class="col">
                                              <h4 class="length-stay">Total length of stay:</h4>
                                                   <h3 class="week-stay">{{$cart['quantity']}} Days</h3>
                                           </div>
                                        </div> --}}
                                    @elseif($cart['category'] == '5')
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h3 class="check-in">From</h3>
                                                <P class="check-dates">
                                                    {{ date_format($myguidecheckindate, 'D, M d, Y ') }}</P>
                                                <!--<h6 class="time-check">00:00</h6>-->
                                            </div>
                                            <div class="col-md-6">
                                                <h3 class="check-in">To</h3>
                                                <P class="check-dates">
                                                    {{ date_format($myguidecheckoutdate, 'D, M d, Y ') }}</P>
                                                <!--<h6 class="time-check">24:00</h6>-->
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        {{--<div class="row">--}}
                                            {{--<div class="col">--}}
                                                {{--<h3 class="length-stay">Duration : {{ $numberDays }} Day</h3>--}}
                                                {{-- <h3 class="week-stay">Place : {{$categoryitem->GuidesLocation}}</h3> --}}
                                            {{--</div>--}}
                                        {{--</div>--}}
                                    @else
                                        <div class="row">
                                ...
                                <div class=" selected_col">
                                    ...
                                    {{-- <div class="row">
                                    <div class="col-md-6"><p>Visitors:</p></div>
                                    <div class="col-md-6"><p>{{$cart['quantity']}}</p></div>
                                </div> --}}

                                    <div class="row">
                                        {{-- <td data-th="Price">Name = {{$cart['title']}},</td>
                                        <td data-th="Price">{{$cart['title']}},</td> --}}
                                        <div class="col-md-6">
                                            <p>Visitors:</p>
                                            <p>Price:</p>
                                        ...
                                        <div class="col-md-6 selected_col_right">
                                            <p>{{ $cart['quantity'] }}</p>
                                            <p>{{ number_format($cart['price'], 2, '.', '') }} / visitor</p>
                                        </div>

                                        {{-- <div class="col-md-6"><p>Price:</p></div>
                                    <div class="col-md-6"><p>{{number_format($cart['price'], 2, '.', '')}} / visitor</p></div> --}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 selected_col_right"><p>{{ $cart['quantity'] }}</p></div>
                                    </div>

                                    <div class="row">
                                        <div class="col-md-6"><p>Price:</p></div>
                                        <div class="col-md-6 selected_col_right"><p>$ {{ $cart['price'] }} / visitor</p></div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="txt_recipt col-md-12">
                                            <p>{{ $cart['quantity'] }} room of price ${{ $cart['price'] }}</p>
                                            <h3> {{ $cart['title'] }}: </h3>
                                        </div>

                                        {{-- <div class="txt_recipt"> --}}
                                        {{-- <p>Quantity :</p> --}}
                                        ...
                                        <div class="txt_recipt col-md-12">
                                            {{-- <p>Price : </p> --}}
                                            <p class="price"> Cost you ${{ $cart['price'] }}</p>
                                        </div>
                                    </div>
                                    ...
                                    @elseif($cart['category'] == '3')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 selected_col_right"><p>
                                                    {{ $cart['pickuplocation'] ?? '' }}
                                                    {{-- in {{$categoryitem->getTransportmainroute->RouteFrom}} --}}
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 selected_col_right"><p>
                                                    {{ $cart['dropofflocation'] ?? '' }}
                                                    {{-- in {{$categoryitem->getTransportmainroute->RouteTo}} --}}
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 selected_col_right">
                                                <p>
                                                    {{ $categoryitem->getTransporttype->TransportationTypeDesc }}
                                                </p>
                                            </div>
                                    ...
                                    @elseif($cart['category'] == '5')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 selected_col_right"><p>{{ $categoryitem->GuidesLocation }}</p></div>
                                        </div>

                                        {{-- <div class="row">
                                            <div class="col-md-6"><p>Language:<p></div>
                                            <div class="col-md-6 selected_col_right"><p>{{ $categoryitem->Languages }}</p></div>
                                        </div> --}}

                                        <div class="row">
                                            <div class="col-md-6"><p>Price:</p></div>
                                            <div class="col-md-6 selected_col_right"><p>{{ $cart['price'] }}/Day</p></div>
                                        </div>
                                        ...
                                        {{-- <tr>
                                                ...
                                                <td data-th="Price">Quantity = {{$cart['quantity']}},</td>
                                                <td data-th="Price">Date = {{$cart['date']}}</td>
                                                <td data-th="Price"><p>Price = ${{$cart['price'] * $numberDays}} --}}
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <a href="{{ url()->previous() }}" class="change-selection">Change your
                                                selection</a>
                                        </div>
                                    </div>
                                ...
                                <div class="row summary-sec">
                                    ...
                                    @if (isset($cart))
                                        <div class="col-md-12" id="totalsummaryheading">
                                            ...
                                            <div class="row">
                                                @if ($cart['category'] == '4')
                                                    <div class="col-md-6" >  <p class="room">Price x {{ $cart['quantity'] }} visitors </p> </diV>
                                                    <div class="col-md-6" id="totalsummaryamount">
                                                        <p class="room" id="_total">$ {{ number_format($total, 2, '.', '') }}</p>
                                                    </div>
                                                    <div class="col-md-6" >  <p class="room">Tax </p></diV>
                                                    <div class="col-md-6" id="totalsummaryamount">
                                                        <p class="room" id="_tax">${{number_format($tax_and_charges??'', 2, '.', '')}}</p>
                                                    </div>
                                                @elseif($cart['category'] == '1')
                                                    <div class="col-md-6" >  <p class="room">Package price x {{ $cart['quantity'] }}
                                                            visitors </p>
                                                    </diV>
                                                    <div class="col-md-6" id="totalsummaryamount">
                                                        <p class="room" id="_total">$ {{ number_format($total, 2, '.', '') }}</p>
                                                ...
                                                @elseif($cart['category'] == '3')
                                                    <div class="col-md-6" >
                                                        <p class="room">Vehicle @if ($cart['triptype'] == 'twoway')
                                                                Round Trip Fare
                                                            @elseif($cart['triptype'] == 'oneway')
                                                                One Way Trip Fare
                                                            @endif
                                                        </p>
                                                    </diV>
                                                ...
                                                @elseif($cart['category'] == '5')
                                                    <div class="col-md-6" >    <p class="room">Guide x {{ $numberDays }} Days</p> </diV>
                                                    <div class="col-md-6" id="totalsummaryamount">
                                                        <p class="room" id="_total">$ {{ number_format($total, 2, '.', '') }}</p>
                                                    </div>
                                                    <div class="col-md-6" >    <p class="room">Tax </p> </diV>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h2 class="your-main-heading" id="finaltotalheading">$
                                                    {{ number_format($total + $tax_and_charges, 2, '.', '') }}</h2>
                                            </div>
                                        </div>
                                        <!--   <div class="row">-->
                                        <!--   <div class="col-md-6">-->
                                ...
                                <input type="hidden" id="finaltotalamount" value="{{ $total + $tax_and_charges }}" />
...
<script async>
    ...
    {{-- // const { clientSecret } = await fetch("{{route('test1')}}", { --}}
    {{-- //     method: "POST", --}}
    {{-- //     headers: { "Content-Type": "application/json" }, --}}
    {{-- //     body: JSON.stringify({ items }), --}}
    {{-- // }).then((r) => r.json()); --}}
    {{-- var elements = stripe.elements({ --}}
    {{-- clientSecret: "pi_3JxHAk2eZvKYlo2C1KRjpbIL_secret_8DwTpsxmlNeMOy9k4gUPDziOh" --}}
    {{-- }); --}}
