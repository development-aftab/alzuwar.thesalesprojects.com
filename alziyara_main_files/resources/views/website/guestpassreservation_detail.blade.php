    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <div class="white-box">
                ...
                <h3 class="box-title m-b-0">Guests Pass Reservation Details</h3>
                ...
                <form  class="form-horizontal" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="GuestPassName" class="form-control"  value="{{$guestpassreserves->getGuestPassOrders->GuestPassName??""}}">
						</div>
